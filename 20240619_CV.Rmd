...
tribble(
  ...
  "PhD Candidate in Social Welfare", "Current", "Florida International University", "Miami, United States",
  "Master in Clinical and Health Psychology", "2014", "Universidad de los Andes", "Bogotá, Colombia",
  " Bachelor in Pyschology", "2012", "Universidad de los Andes", "Bogotá, Colombia"
) %>% 
...
honors <-  tribble(
  ...
  "Outstanding Graduate Recognition", "Florida International University", 2024, "Extraordinary academic, professional, and personal achievements as a graduate student from FIU", "Miami, FL",
